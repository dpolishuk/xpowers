...
- Run /skill:sre-task-refinement on all tasks
...
- After /skill:review-implementation flags test quality issues
- Planning test improvement initiatives

**Don't use when:**
- Writing new tests (use /skill:test-driven-development)
- Debugging test failures (use /skill:debugging-with-tools)
- Just need to run tests (use /skill:test-runner agent)
</when_to_use>

<the_process>
## Announcement

**Announce:** "I'm using /skill:analyzing-test-effectiveness to audit test quality with Google Fellow SRE-level scrutiny."
...
```
Announce: "I'm using /skill:sre-task-refinement to review these test improvement tasks."

Load skill: /skill:sre-task-refinement
```
...
- [ ] All tasks reviewed with /skill:sre-task-refinement
...
2. Implement tasks using /skill:executing-plans
...
10. **SRE refinement on all tasks** → Run /skill:sre-task-refinement before execution
...
- [ ] Ran /skill:sre-task-refinement on ALL tasks
...
- /skill:review-implementation (when test quality issues flagged)
- User request to audit test quality
- Before major refactoring efforts

**This skill calls (MANDATORY):**
- /skill:sre-task-refinement (for ALL bd tasks created)
- /skill:test-runner agent (to run tests during analysis)
- /skill:test-effectiveness-analyst agent (for detailed analysis)
...
**This skill informs:**
- /skill:sre-task-refinement (test specifications in plans)
- /skill:test-driven-development (what makes a good test)
