...
- After /skill:writing-plans creates initial plan
- Before /skill:executing-plans starts implementation
...
**Announce:** "I'm using /skill:sre-task-refinement to review this plan with Google Fellow-level scrutiny."
...
- After changes, re-run /skill:sre-task-refinement
...
- /skill:writing-plans (creates initial plan)
- /skill:brainstorming (establishes requirements)

**This skill is used before:**
- /skill:executing-plans (implements tasks)

**This skill is also called by:**
- /skill:executing-plans (REQUIRED for new tasks created during execution)

**Call chains:**
```
Initial planning:
/skill:brainstorming → /skill:writing-plans → /skill:sre-task-refinement → /skill:executing-plans
                                                    ↓
                                            (if gaps: revise and re-review)

During execution (for new tasks):
/skill:executing-plans → creates new task → /skill:sre-task-refinement → STOP checkpoint
```
