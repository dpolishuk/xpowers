...
- Called by /skill:review-implementation (final step)
...
Dispatch /skill:test-runner agent:
```
Run: cargo test
...
Dispatch /skill:test-runner: "Run: <test command>"
...
- /skill:review-implementation (final step after approval)
...
**This skill calls:**
- /skill:test-runner agent (for test verification)
