...
const HOSTS: HostConfig[] = [
  ...
  },
  {
    ...
    availableFeatures: [],
    postInstall: async (targetDir, installedFiles) => {
      // ZCode has no user-scope subagent registry; expose xpowers agents via
      // the codex-agent-* wrapper skills generated by scripts/sync-codex-skills.js.
