...
install_tm_cli() {
  ...
  cp "${REPO_ROOT}/scripts/tm-acceptance.js" "${TM_LIB_DIR}/tm-acceptance.js"
  ...
  ln -sfn "${TM_LIB_DIR}/tm-acceptance.js" "${TM_BIN_DIR}/tm-acceptance.js"
...
uninstall_tm_cli() {
  ...
  rm -f "${TM_BIN_DIR}/tm-acceptance.js"
